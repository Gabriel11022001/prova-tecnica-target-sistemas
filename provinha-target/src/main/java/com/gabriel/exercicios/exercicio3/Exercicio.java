...
public class Exercicio {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println("Valor da média mensal: R$" + mediaFaturamentos);
			System.out.println("Quantidade de dias em que o faturamento foi maior que a média mensal: " + quantidadeDiasQueOFaturamentoFoiMaiorQueAMediaMensal);
		} catch (Exception e) {
